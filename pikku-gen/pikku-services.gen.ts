...
export type RequiredSingletonServices = Pick<SingletonServices, Extract<keyof SingletonServices, 'config' | 'jwt' | 'logger' | 'schema' | 'variables'>> & Partial<Omit<SingletonServices, 'config' | 'jwt' | 'logger' | 'schema' | 'variables'>>
